...
Where:
- $\gamma_{sv}$ is the surface-vapour tension
- $\gamma_{sl}$ is the surface-liquid tension
- $\gamma_{lv}$ is the liquid-vapour tension
...
##### Cahn's Scaling Law
Cahn's theory explains the scaling behaviour of surface tensions as the critical temperature $T_c$ is approached (see: [@cahn1977critical]). The surface tension vanishes following the power law:
